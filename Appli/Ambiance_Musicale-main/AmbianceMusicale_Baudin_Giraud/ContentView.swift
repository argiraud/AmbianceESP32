...
//
//  Created by Maxime Baudin on 07/01/2021.
//
                            ...
                            HStack(spacing: 15){
                                ...
                                VStack{
                                    ...
                                    if self.revisible{
                                        ...
                                        TextField("Confirmation Mot de passe", text: self.$repass)
                                            .autocapitalization(.none)
                                    }
                                    else{
...
struct ErrorView : View {
      ...
      var body: some View{
          ...
          .background(Color.white.opacity(0.35).edgesIgnoringSafeArea(.all))
      }
  }
